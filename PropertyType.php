...
$propertyTitle1="House";
$propertyTitle2="Cluster";
$propertyTitle3="Apartment";
$propertyTitle4="Townhouse Simplex";
$propertyTitle5="Townhouse Duplex";
$propertyTitle6="Stand";
$propertyTitle7="Commercial";
$propertyTitle8="Agricultural";
$propertyTitle9="Farm";
//$propertyTitle9="Farm";
...
<head>
  ...
  <title>Property-100|Property Categories</title>
            ...
            <?php
                ...
                if($idFilter ==1)
                {
                  foreach ($data as $name => $info ) {
                    ...
                    if ($info['title'] != "House" && $info['title'] != "Cluster")
                    {
                      unset($data[$name]);
                    }
                   }
                ...
                if($idFilter ==2)
                {
                  foreach ($data as $name => $info ) {
                    ...
                    if ($info['title'] != "Apartment" && $info['title'] != "Townhouse Simplex" && $info['title'] != "Townhouse Duplex")
                    {
                      unset($data[$name]);
                    }
                   }
...
<a href="#" class="text-muted text-left sitemap sitemap whiteText footerFont" ><b>HOME</b> </a>

</div>
<div   class="col-md-6 col-6 text-left">  

<a  href="" class="text-muted  sitemap whiteText footerFont"><b>TO LET</b></a>

</div>
<div  class="col-md-6 col-6 text-left">

<a  href="" class="text-muted whiteText sitemap text-left footerFont"><b>FOR SALE</b> </a>

</div>
<div class="col-md-6 col-6 text-left">  

<a  href="" class="text-muted text-left sitemap whiteText footerFont"><b>ABOUT US</b></a>

</div>
<div class="col-md-6 col-6 text-left">

<a  href="" class="text-muted text-left sitemap whiteText footerFont"><b>AGENTS</b> </a>
