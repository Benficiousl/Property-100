  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link js-scroll-trigger active" style="color:#8cd509;" href="ForSale.php"><span>For Sale</span></a>
      </li>
...
<div class="ws_images"><ul>
  ...
  <li><img src="img/Property-100_For-Sale-Header.png" alt="Header banner 3" title="" id="wows1_0"/></li>
   </ul></div>
            ...
            <div class="col-lg-12 text-center">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <h2 class="text-center section-heading" style="padding-bottom: 0em;">FIND YOUR HOME IN YOUR CITY</h2>
                  ...
                  foreach ($data as $name => $info ) {
                         ...
                         if($propertyType =="")
                         {
                           $propertyType =  $info['title'] ;
                            ...
                            if($Bedrooms == "5")
                              {
                                if ($info['price'] > $maxprice|| $info['price'] < $minprice || $info['city'] != $propertyLocation || $info['bathrooms'] > 100 || $info['bedrooms'] != $Bathrooms || $info['title'] != $propertyType || $info['sale_type'] != "Sale")
                                {                           
                              ...
                              {
                                if ($info['price'] > $maxprice|| $info['price'] < $minprice || $info['city'] != $propertyLocation || $info['bathrooms'] > 100 || $info['bedrooms'] != $Bedrooms || $info['title'] != $propertyType || $info['sale_type'] != "Sale")
                                {                           
                              ...
                              {
                                if ($info['price'] > $maxprice|| $info['price'] < $minprice|| $info['city'] != $propertyLocation || $info['bathrooms'] > 100 || $info['bedrooms'] > 100 || $info['title'] != $propertyType || $info['sale_type'] != "Sale")
                                {                           
                        ...
                        // if ($info['price'] > $maxprice || $info['price'] < $minprice || $info['city'] != $propertyLocation || $info['bathrooms'] != $Bathrooms || $info['bedrooms'] != $Bedrooms || $info['title'] != $propertyType)
                        // {                           
...
<a  href="#top" class="text-muted whiteText sitemap text-left footerFont"><b style="color:#8cd509;">FOR SALE</b> </a>
