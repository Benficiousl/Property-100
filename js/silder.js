    ...
    $("#Pflip").click(function(){
      $("#PanelHide").slideDown("slow");
      $("#Pflip").hide();
      $("#PflipUp").show();
      
  });

  $("#PflipUp").click(function(){
    $("#PanelHide").slideUp("slow");
    $("#PflipUp").hide();
    $("#Pflip").fadeIn(2000);
});
;
        ...
        rangeSlider.noUiSlider.on('update', function(values, handle) {
          ...
          document.getElementById('slider-range-value21').innerHTML = values[1];
          document.getElementsByName('min-value1').value = moneyFormat.from(
            values[0]);
          document.getElementsByName('max-value1').value = moneyFormat.from(
            values[1]);

            document.getElementById('minP').value = moneyFormat.from(values[0]);

            document.getElementById('maxP').value = moneyFormat.from(values[1]);
      ...
      $(document).ready(function() {
        ...
        rangeSlider.noUiSlider.on('update', function(values, handle) {
          ...
          document.getElementsByName('max-value').value = moneyFormat.from(
            ...
            document.getElementById('minArea').value = moneyFormat.from(values[0]);

            document.getElementById('maxArea').value = moneyFormat.from(values[1]);
        });
      });
      ...
      $(document).ready(function() {
        ...
        rangeSlider.noUiSlider.on('update', function(values, handle) {
          document.getElementById('slider-range-value11').innerHTML = values[0];
          document.getElementById('slider-range-value21').innerHTML = values[1];
          document.getElementsByName('min-value11').value = moneyFormat.from(
            values[0]);
          document.getElementsByName('max-value21').value = moneyFormat.from(
            values[1]);
