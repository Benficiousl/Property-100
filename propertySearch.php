            ...
            <?php
                ...
                rsort($data);
                    ...
                    foreach ($data as $name => $info ) {
                      if (($info['city'] != $propertyLocation && $propertyLocation !="null") || ($info['title'] != $propertyType && $propertyType !="null") || ($info['bathrooms'] != $Bathrooms && $Bathrooms !="0")|| ($info['bedrooms'] != $Bedrooms && $Bedrooms !="0"))
                      {                           
                 ...
                 //  echo('<script>alert("ran '.$var.' times")</script>');
...
function myFunction() {
    // Store
    var jobValue = document.getElementById('Bedrooms').value
    localStorage.setItem("lastname", jobValue);
    // Retrieve
