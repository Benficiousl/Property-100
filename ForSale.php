...
<div id="about" ></div>
  <section style="padding: 2.2rem 9rem 1rem; background-color: #212121!important;" class="bg-primary" >
    <div class="container" >
          <div class="row">
 ...
 <section id="services mx-auto" style="padding: 2rem; background-color: #dddddd;">
    <div class="container">
    <form action="propertySearchSale.php">
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-6">
          <br />
          <a id = "button" class="btn btntransparent  btn-3 btn-lg" style="
                    background-color: #034ea1 !important;
                    border: solid !important;
                    border-color: #034ea1 !important;
            ...
            <div class="col-lg-12 text-center">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <h2 class="text-center section-heading" style="padding-bottom: 0em;">SALES</h2>
...
<a  href="ForSale.php" class="text-muted whiteText sitemap text-left footerFont"><b style="color:#8cd509;">FOR SALE</b> </a>
 ...
 $(function(){
    ...
    $.ajax({
      ...
      success: function(data) {
       // document.getElementById("demo1").innerHTML = "Teboho <br />";
