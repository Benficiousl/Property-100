...
<head>
  ...
  <title>Property-100 | Contact Us</title>
  ...
  <style>
/* //Property-100_Call-Us-Header.png */
  ...
  <div class="collapse navbar-collapse" id="navbarResponsive">
    ...
    <ul class="navbar-nav ml-auto">
      ...
      <li class="nav-item">
        ...
        <a class="nav-link js-scroll-trigger active" style="color:#8cd509;" href="contactUs.php"><span>Contact Us</span></a>
...
<div class="ws_images"><ul>
  ...
  <li><img src="img/Property-100_Call-Us-Header.png" alt="Header banner 3" title="" id="wows1_0"/></li>
   </ul></div>
  ...
  <section style=" padding: 2rem 0; background-color: #212121!important;">
    <div class="container" >
          <div class="row">
            ...
            <h1 style="color:#fff; font-size:50px;">We would<span style="color: #8cd509"> love to hear </span> from you!</h1>
            </div>
          </div>
    ...
    <!-- New Stories Section-->
      ...
      <div class="container">
          ...
          <div class="col-lg-12 text-center">
                  ...
                  <h2 class="text-center section-heading" style="padding-bottom: 0em;">GET IN TOUCH WITH US</h2>
                  <span class="text-center">PROPERTY-100</span>
  ...
  <section class="bg-dark text-white" style="padding: 4rem 0 3rem;background-image: url(img/HomepageAssets/Banner2.png);">
...
<div class="col-lg-12 text-center">
           <h2 class="mb-4" style="color:#034ea1;padding-top: 4rem;padding-bottom: 0rem;"><b>PROPERTY-100</b><span style="color: #777"> EXPERIENCE OUR REFRESHING APROACH</span></h2>
     </div>
...
<a href="#top" class="text-muted text-left sitemap whiteText footerFont"><b style="color:#8cd509;">CONTACT US</b></a>
