...
<head>
  ...
  <title>Property-100 | About</title>
...
<div class="row">
  ...
  <header id="#agent" class="text-center text-white d-flex">
            ...
            <div class="col-lg-12 text-center">
              <div class="row">
                <div class="col-lg-12">
                  ...
                  <h2 class="text-center section-heading" style="padding-bottom: 0em;">DO YOU WANT TO JOIN OUR PROFESSIONAL TEAM</h2>
              ...
              <div class="container">
                  <div class="row  text-left">
                      <br /><br />
                        <p style= "font-size: 20px; text-left">Our Pretoria, Hartbeespoort and Johannesburg North divisions are well established, we recently opened the Johannesburg Eastern Suburbs division. With this growth, we have opportunities for experienced and intermediate property practitioners at all of our branches.<br /> <br />
We offer the following:
</p>

<ul style= "font-size: 20px;">
  <li>Above average commission split</li>
  <li>No desk fees</li>
  <li>Complimentary starter kit</li>
  <li>No hidden costs</li>
  <li>Training which includes the Logbook training</li>
  <li>Administrative support</li>
  <li>CRM system which is user friendly</li>
  <li>Access to Lightstone</li>
  <li>Data base already in place</li>
  ...
  <li>Legal backup</li>
          ...
          <div class="col-lg-12 text-center">
              <div class="row">
                <div class="col-lg-12">
                  <h2 style ="color: #034ea1" class="text-center section-heading" style="padding-bottom: 0em;">EMAIL YOUR CV TO</h2>
                   <br />
                </div>
           ...
           <div class="container">
                  <div class="row">
                      ...
                      <p><b>JHB NORTHERN SUBUBS</b></p>
                              </p>ilse@property-100.co.za</p>
                      </div>
                      <div class="col-lg-3 col-sm-6 text-center mb-4">
                      <p><b>JHB EASTERN SUBURBS</b></p>
                              </p>adri@property-100.co.za</p>
                        </div>
                        <div class="col-lg-3 col-sm-6 text-center mb-4">
                        <p><b>PRETORIA</b></p>
                              </p>michelle@property-100.co.za</p>
                          </div>
                          <div class="col-lg-3 col-sm-6 text-center mb-4">
                             <p><b>HARTBEESPOORT</b></p>
                              </p>Isabel@property-100.co.za</p>
                            </div>
                        </div>
                    </div>
               </div>
